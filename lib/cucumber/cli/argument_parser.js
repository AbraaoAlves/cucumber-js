function ArgumentParser(argv) {
  ...
  var self = {
    ...
    getKnownOptionDefinitions: function getKnownOptionDefinitions() {
      ...
      definitio
      ns[ArgumentParser.STRICT_FLAG_NAME]                 = Boolean;
    ...
    s
    houldSnippetsBeShown: function shouldSnippetsBeInCoffeeScript() {
...
ArgumentParser.TYPESCRIPT_SCRIPT_SNIPPETS_FLAG_NAME          = 'coffee';
ArgumentParser.DEFAULT_TYPESCRIPT_SCRIPT_SNIPPETS_FLAG_VALUE = false;
